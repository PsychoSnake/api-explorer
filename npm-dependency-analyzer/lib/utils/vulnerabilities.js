...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (dependencies, cacheTime) {
    ...
    logger.info('ENV_VAR: ' + process.env.CENTRAL_SERVER_TOKEN)
      ...
      dependencyVulnerabilities.forEach(function (elem) {
        ...
        elem.vulnerabilities.forEach(function (vulnerability) {
          if (!dependency.vulnerabilities.some(function (depElem) {
            ...
            dependency.vulnerabilities.push(new _report_model.Vulnerability({ // TODO: ver a possibilidade de passar literalmente o objeto vulnerability do forEach() no constructor
              id: vulnerability.id,
